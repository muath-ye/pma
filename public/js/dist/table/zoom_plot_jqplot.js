...
/* harmony import */ var _modules_sql_highlight_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(12);
/* harmony import */ var _modules_ajax_message_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(10);
 ...
 */
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerTeardown('table/zoom_plot_jqplot.js', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#resizer').off('resizestop');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#querychart').off('jqplotDataClick');
});
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('table/zoom_plot_jqplot.js', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#tableid_0').on('change', function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().post('index.php?route=/table/zoom-search', {
      ...
      _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.addDateTimePicker();
    });
  });
  ...
  if (searchedData !== null) {
    ...
    var options = {
      ...
      axes: {
        xaxis: {
          ...
          labelRenderer: (jquery__WEBPACK_IMPORTED_MODULE_0___default().jqplot).CanvasAxisLabelRenderer
        },
        yaxis: {
    ...
    currentChart = jquery__WEBPACK_IMPORTED_MODULE_0___default().jqplot('querychart', series, options);
    currentChart.resetZoom();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('button.button-reset').on('click', function (event) {
      event.preventDefault();
      currentChart.resetZoom();
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#resizer').resizable();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#resizer').on('resizestop', function () {
      // make room so that the handle will still appear
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#querychart').height(jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#resizer').height() * 0.96);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#querychart').width(jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#resizer').width() * 0.96);
      currentChart.replot({
        resetAxes: true
      });
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#querychart').on('jqplotDataClick', function (event, seriesIndex, pointIndex, data) {
...
/******/ __webpack_require__.O(0, [41], function() { return __webpack_exec__(92); });
