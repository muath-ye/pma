...
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerTeardown('table/select.js', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).off('click', 'span.open_search_gis_editor');
...
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('table/select.js', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('submit', '#tbl_search_form.ajax', function (event) {
    ...
    _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.prepareForAjaxRequest($searchForm);
    var values = {};
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('span.open_search_gis_editor').hide();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'span.open_search_gis_editor', function (event) {
    event.preventDefault();
    var $span = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    // Current value
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        ...
        success: function (response) {
          ...
          if (response.success) {
            ...
            _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.addDatepicker(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#min_value'), dataType);
            _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.addDatepicker(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#max_value'), dataType);
...
/******/ __webpack_require__.O(0, [41], function() { return __webpack_exec__(89); });
