...
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('database/search.js', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#select_all').on('click', function () {
    _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.setSelectOptions('db_search', 'criteriaTables[]', true);
    return false;
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#unselect_all').on('click', function () {
    _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.setSelectOptions('db_search', 'criteriaTables[]', false);
    return false;
  });
}); // end $()
...
/******/ __webpack_require__.O(0, [41], function() { return __webpack_exec__(35); });
