...
/* harmony import */ var _modules_functions_escape_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(17);
...
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('database/multi_table_query.js', function () {
  var editor = _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.getSqlEditor(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#MultiSqlquery'), {}, 'vertical');
  ...
  function addNewColumnCallbacks() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tableNameSelect').each(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).on('change', function () {
        var $sibs = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings('.columnNameSelect');
        if ($sibs.length === 0) {
          $sibs = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().parent().find('.columnNameSelect');
        }
        $sibs.first().html(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find(':selected').data('hash')).html());
      });
    });
...
/******/ __webpack_require__.O(0, [41], function() { return __webpack_exec__(31); });
