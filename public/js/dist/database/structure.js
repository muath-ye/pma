...
/* harmony import */ var _modules_tooltip_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(11);
...
/* harmony import */ var _modules_functions_escape_ts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(17);
...
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('database/structure.js', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'a.truncate_table_anchor.ajax', function (event) {
     ...
     */
    var question = window.Messages.strTruncateTableStrongWarning + ' ' + window.sprintf(window.Messages.strDoYouReally, 'TRUNCATE `' + (0,_modules_functions_escape_ts__WEBPACK_IMPORTED_MODULE_8__.escapeHtml)(currTableName) + '`') + _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.getForeignKeyCheckboxLoader();
    ...
    }, _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.loadForeignKeyCheckbox);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'a.drop_table_anchor.ajax', function (event) {
    ...
    question += _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.getForeignKeyCheckboxLoader();
    $thisAnchor.confirm(question, $thisAnchor.attr('href'), function (url) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('a.real_row_count').on('click', function (event) {
    event.preventDefault();
    DatabaseStructure.fetchRealRowCount(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this));
  });
...
/******/ __webpack_require__.O(0, [41], function() { return __webpack_exec__(36); });
