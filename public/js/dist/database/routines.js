...
/* harmony import */ var _modules_ajax_message_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(10);
...
const DatabaseRoutines = {
  ...
  exportDialog: function ($this) {
    ...
    function showExport(data) {
      ...
      _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.getSqlEditor($elm);
    } // end showExport()
  },
  // end exportDialog()
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().get($this.attr('href'), {
      ...
      buttonOptions[window.Messages.strGo].click = function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default().post(url, data, function (data) {
          ...
          (0,_modules_ajax_message_ts__WEBPACK_IMPORTED_MODULE_4__.ajaxRemoveMessage)($msg);
          _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.slidingMessage(data.message);
      ...
      that.$ajaxDialog = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div id="rteDialog">' + data.message + '</div>').dialog({
        ...
        open: function () {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('input.datefield').each(function () {
            _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.addDatepicker(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).css('width', '95%'), 'date');
          });
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('input.datetimefield').each(function () {
            _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.addDatepicker(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).css('width', '95%'), 'datetime');
          });
          // @ts-ignore
      ...
      that.syntaxHiglighter = _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.getSqlEditor($elm, {}, 'vertical', linterOptions);
  ...
  dropDialog: function ($this) {
    ...
    $this.confirm(question, $this.attr('href'), function (url) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default().post(url, params, function (data) {
        ...
        _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.slidingMessage(data.sql_query);
        _modules_navigation_ts__WEBPACK_IMPORTED_MODULE_3__.Navigation.reload();
      }); // end $.post()
    });
  },
  ...
  executeDialog: function ($this) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().post($this.attr('href'), params, function (data) {
      ...
      $ajaxDialog.find('input.datefield, input.datetimefield').each(function () {
        _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.addDatepicker(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).css('width', '95%'));
      });
      /*
...
/******/ __webpack_require__.O(0, [41], function() { return __webpack_exec__(34); });
