...
/* harmony import */ var _modules_sql_highlight_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(12);
/* harmony import */ var _modules_ajax_message_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(10);
/* harmony import */ var _modules_functions_escape_ts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17);
  ...
  var g = {
    ...
    showEditCell: function (cell) {
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(cell).is('.grid_edit') && !g.colRsz && !g.colReorder) {
        if (!g.isCellEditActive) {
          ...
          var value = _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.getCellValue(cell);
          if ($cell.attr('data-type') === 'json' && $cell.is('.truncated') === false) {
            value = _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.stringifyJSON(value, null, 4);
          }
      ...
      if (data) {
        if (g.currentEditCell) {
          ...
          if (isNull) {
            ...
            if (!_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.updateCode($target, newHtml, value)) {
              $target.html(newHtml);
            }
          }
          if ($thisField.is('.bit')) {
    ...
    showEditArea: function () {
      if (!g.isCellEditActive) {
        ...
        if ($td.is('.relation')) {
            ...
            g.lastXHR = jquery__WEBPACK_IMPORTED_MODULE_0___default().post('index.php?route=/sql', {
              ...
              if (typeof data !== 'undefined' && data.success === true) {
                if ($td.attr('data-type') === 'json') {
                  data.value = _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.stringifyJSON(data.value, null, 4);
                }
          ...
          // add datetime picker
          _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.addDatepicker($inputField, $td.attr('data-type'), {
          ...
          $inputField.on('keyup', function (e) {
            if (e.which === 13) {
              ...
              _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.toggleDatepickerIfInvalid($td, $inputField);
            }
          });
        ...
        $tr.find('.to_be_saved').each(function () {
          ...
          if (isNull) {
            ...
            if ($thisField.attr('data-type') !== 'json') {
              ...
              const JSONString = _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.stringifyJSON($thisField.data('value'));
              ...
              jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('a').each(function () {
                ...
                if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('href').indexOf('DELETE') > -1) {
                  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).removeAttr('onclick').off('click').on('click', function () {
                    return _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.confirmLink(this, 'DELETE FROM `' + g.db + '`.`' + g.table + '` WHERE ' + decodedNewClause + (isUnique ? '' : ' LIMIT 1'));
                  });
                }
              });
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(g.cEdit).find('.edit_area').is('.edit_area_loading')) {
        ...
        if ($thisField.is('.bit')) {
          ...
          if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(g.cEdit).find('.edit_box').val().match(/^(0x)?[a-f0-9]*$/i) !== null) {
            ...
            thisFieldParams[fieldName] = _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.getCellValue(g.currentEditCell);
          }
        } else {
          thisFieldParams[fieldName] = jquery__WEBPACK_IMPORTED_MODULE_0___default()(g.cEdit).find('.edit_box').val();
        }
        let isValueUpdated;
        if ($thisField.attr('data-type') !== 'json') {
          isValueUpdated = thisFieldParams[fieldName] !== _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.getCellValue(g.currentEditCell);
        } else {
          const JSONString = _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.stringifyJSON(thisFieldParams[fieldName]);
          isValueUpdated = JSONString !== JSON.stringify(JSON.parse(_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.getCellValue(g.currentEditCell)));
        }
    ...
    initColReorder: function () {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(g.t).find('th.draggable').on('mousedown', function (e) {
        ...
        e.preventDefault();
        var res = _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.copyToClipboard(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('column'));
        if (res) {
...
/******/ __webpack_require__.O(0, [41], function() { return __webpack_exec__(64); });
