      ...
      var performUpload = function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON('index.php?route=/import-status', {
          ...
          if (total === 0 && complete === 0 && percent === 0) {
            ...
            var statusText = window.sprintf(window.Messages.uploadProgressStatusText, _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.formatBytes(complete, 1, window.Messages.strDecimalSeparator), _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.formatBytes(total, 1, window.Messages.strDecimalSeparator));
            if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#importmain').is(':visible')) {
              ...
              var speed = window.sprintf(window.Messages.uploadProgressPerSecond, _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.formatBytes(complete / usedTime * 1000, 1, window.Messages.strDecimalSeparator));
...
/******/ __webpack_require__.O(0, [41], function() { return __webpack_exec__(53); });
