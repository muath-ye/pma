...
/* harmony import */ var _modules_console_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
...
/* harmony import */ var _ajax_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
...
/* harmony import */ var _navigation_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8);
/* harmony import */ var _console_config_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(26);
/* harmony import */ var _functions_config_ts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(15);
/* harmony import */ var _functions_escape_ts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(17);
...
var Console = {
  ...
  initialize: function () {
    ...
    (0,_functions_config_ts__WEBPACK_IMPORTED_MODULE_7__.getConfigValue)('Console', false, data => {
      _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.init(data);
      Console.setupAfterInit();
    }, () => {
      _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.init({}); // Avoid null pointers in setupAfterInit()
  ...
  setupAfterInit: function () {
    ...
    if (Console.isInitialized === false) {
      // Load config first
      if (_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.AlwaysExpand) {
        document.getElementById('consoleOptionsAlwaysExpandCheckbox').checked = true;
      }
      if (_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.StartHistory) {
        document.getElementById('consoleOptionsStartHistoryCheckbox').checked = true;
      }
      if (_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.CurrentQuery) {
        document.getElementById('consoleOptionsCurrentQueryCheckbox').checked = true;
      }
      if (_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.EnterExecutes) {
        document.getElementById('consoleOptionsEnterExecutesCheckbox').checked = true;
      }
      if (_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.DarkTheme) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pma_console_options').find('input[type=checkbox]').on('change', function () {
        _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.update();
      });
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#consoleOptionsEnterExecutesCheckbox').on('change', function () {
        ConsoleMessages.showInstructions(_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.EnterExecutes);
      });
    ...
    switch (_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.Mode) {
      case 'collapse':
        Console.collapse();
        break;
      case 'info':
      ...
      case 'show':
        ...
        break;
      default:
        _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.set('Mode', 'info');
        Console.info();
    }
  },
  /**
  ...
  execute: function (queryString) {
    ...
    if (!_functions_ts__WEBPACK_IMPORTED_MODULE_3__.Functions.confirmQuery(Console.$requestForm[0], Console.$requestForm.children('textarea')[0].value)) {
      return;
    }
  ...
  ajaxCallback: function (data) {
    if (data && data.console_message_id) {
      ...
      if (data.reloadQuerywindow.sql_query.length > 0) {
        ...
        // @ts-ignore
        .$message.addClass(_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.CurrentQuery ? '' : 'hide');
      }
    }
  },
  /**
   ...
   */
  collapse: function () {
    _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.set('Mode', 'collapse');
    var pmaConsoleHeight = Math.max(92, _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.Height);
  ...
  show: function () {
    ...
    _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.set('Mode', 'show');
    var pmaConsoleHeight = Math.max(92, _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.Height);
    // eslint-disable-next-line compat/compat
    pmaConsoleHeight = Math.min(_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.Height, (window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight) - 25);
    Console.$consoleContent.css({
      display: 'block'
    });
   ...
   */
  toggle: function () {
    if (_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.Mode === 'show') {
      Console.collapse();
    } else {
      Console.show(true);
    }
...
var ConsoleResizer = {
   ...
   */
  mouseUp: function () {
    _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.set('Height', Math.round(ConsoleResizer.resultHeight));
    Console.show();
...
var ConsoleInput = {
  ...
  initialize: function () {
    ...
    if (ConsoleInput.codeMirror) {
      ...
      ConsoleInput.inputs.console.on('inputRead', _functions_ts__WEBPACK_IMPORTED_MODULE_3__.Functions.codeMirrorAutoCompleteOnInputRead);
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pma_bookmarks').length !== 0) {
        ...
        ConsoleInput.inputs.bookmark.on('inputRead', _functions_ts__WEBPACK_IMPORTED_MODULE_3__.Functions.codeMirrorAutoCompleteOnInputRead);
      }
    } else {
...
var ConsoleMessages = {
  ...
  append: function (msgString, msgType) {
    ...
    var now = new Date();
    var $newMessage = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="message ' + (_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.AlwaysExpand ? 'expanded' : 'collapsed') + '" msgid="' + msgId + '"><div class="action_content"></div></div>');
    switch (msgType) {
      case 'query':
...
var ConsoleDebug = {
  ...
  initialize: function () {
    ...
    if (_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.GroupQueries) {
      ...
      if (_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.OrderBy === 'count') {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#debug_console').find('.button.order_by.sort_exec').addClass('active');
      }
    }
    var orderBy = _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.OrderBy;
    var order = _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.Order;
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#debug_console').find('.button.group_queries').on('click', function () {
      ...
      _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.set('GroupQueries', true);
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#debug_console').find('.button.ungroup_queries').on('click', function () {
      ...
      _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.set('GroupQueries', false);
      ConsoleDebug.refresh();
      if (_console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.OrderBy === 'count') {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#debug_console').find('.button.order_by.sort_exec').addClass('active');
      }
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#debug_console').find('.button.order_by').on('click', function () {
      ...
      if ($this.hasClass('sort_time')) {
        _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.set('OrderBy', 'time');
      } else if ($this.hasClass('sort_exec')) {
        _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.set('OrderBy', 'exec');
      } else if ($this.hasClass('sort_count')) {
        _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.set('OrderBy', 'count');
      }
      ConsoleDebug.refresh();
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#debug_console').find('.button.order').on('click', function () {
      ...
      if ($this.hasClass('order_asc')) {
        _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.set('Order', 'asc');
      } else if ($this.hasClass('order_desc')) {
        _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.set('Order', 'desc');
      }
      ConsoleDebug.refresh();
    });
  ...
  formatFunctionArgs: function (dbgStep) {
    ...
    if (dbgStep.args.length) {
      ...
      for (var i = 0; i < dbgStep.args.length; i++) {
        $args.append(jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="message">').html('<pre>' + (0,_functions_escape_ts__WEBPACK_IMPORTED_MODULE_8__.escapeHtml)(JSON.stringify(dbgStep.args[i], null, '  ')) + '</pre>'));
      }
    }
    return $args;
  },
  ...
  showLog: function (debugInfo) {
    ...
    function sortByTime(a, b) {
      var order = _console_config_ts__WEBPACK_IMPORTED_MODULE_6__.Config.Order === 'asc' ? 1 : -1;
...
/* harmony export */ });
/* harmony import */ var _functions_config_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
...
const Config = {
  ...
  set: function (key, value) {
    this[key] = value;
    (0,_functions_config_ts__WEBPACK_IMPORTED_MODULE_0__.setConfigValue)('Console/' + key, value);
  },
  /**
...
/******/ __webpack_require__.O(0, [41], function() { return __webpack_exec__(4); });
