...
/* harmony import */ var _modules_keyhandler_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(57);
/* harmony import */ var _modules_page_settings_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(58);
/* harmony import */ var _modules_cross_framing_protection_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(59);
/* harmony import */ var _modules_indexes_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(60);
/* harmony import */ var _modules_config_ts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(9);
/* harmony import */ var _modules_functions_checkNumberOfFields_ts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(20);
/* harmony import */ var _modules_navigation_event_loader_ts__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(61);
/* harmony import */ var _modules_functions_event_loader_ts__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(63);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default().ajaxPrefilter(_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.addNoCacheToAjaxRequests);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.dismissNotifications());
jquery__WEBPACK_IMPORTED_MODULE_0___default()(_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.initializeMenuResizer());
jquery__WEBPACK_IMPORTED_MODULE_0___default()(_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.floatingMenuBar());
jquery__WEBPACK_IMPORTED_MODULE_0___default()(_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.breadcrumbScrollToTop());
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _functions_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(22);
/* harmony import */ var _handleCreateViewModal_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(62);
...
function teardownFunctions() {
  return function () {
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.teardownIdleEvent();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).off('click', 'input:checkbox.checkall');
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.teardownSqlQueryEditEvents();
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.removeAutocompleteInfo();
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.teardownCreateTableEvents();
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.teardownEnumSetEditorMessage();
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.teardownEnumSetEditor();
    ...
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.teardownRecentFavoriteTables();
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.teardownCodeMirrorEditor();
    ...
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.teardownCreateView();
    ...
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.teardownSortLinkMouseEvent();
  };
}
/**
 * @return {function}
...
function onloadFunctions() {
  return function () {
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.onloadIdleEvent();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'input:checkbox.checkall', _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.getCheckAllCheckboxEventHandler());
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.addDateTimePicker();
    /**
    ...
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.onloadSqlQueryEditEvents();
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.onloadCreateTableEvents();
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.onloadChangePasswordEvents();
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.onloadEnumSetEditorMessage();
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.onloadEnumSetEditor();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#index_frm input[type=submit]', _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.getAddIndexEventHandler());
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.showHints();
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.initializeToggleButtons();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', 'select.pageselector', _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.getPageSelectorEventHandler());
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.onloadRecentFavoriteTables();
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.onloadCodeMirrorEditor();
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.onloadLockPage();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', '.autosubmit', _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.getAutoSubmitEventHandler());
    document.querySelectorAll('.jsPrintButton').forEach(item => {
    ...
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.onloadCreateView();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.checkboxesSel, _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.checkboxesChanged);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', 'input.checkall_box', _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.getCheckAllBoxEventHandler());
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.checkall-filter', _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.getCheckAllFilterEventHandler());
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.checkboxesSel + ', input.checkall_box:checkbox:enabled', _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.subCheckboxesChanged);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', 'input.sub_checkall_box', _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.getSubCheckAllBoxEventHandler());
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('keyup', '#filterText', _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.getFilterTextEventHandler());
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.onloadFilterText();
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.onloadLoginForm();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('form input, form textarea, form select').on('keydown', _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.getKeyboardFormSubmitEventHandler());
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', 'select#select_authentication_plugin_cp', _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.getSslPasswordEventHandler());
    _functions_ts__WEBPACK_IMPORTED_MODULE_1__.Functions.onloadSortLinkMouseEvent();
  };
}
...
/* harmony import */ var _functions_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(22);
/* harmony import */ var _navigation_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default().post($this.attr('href'), params, function (data) {
    if (typeof data !== 'undefined' && data.success === true) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#createViewModal').on('shown.bs.modal', function () {
        window.codeMirrorEditor = _functions_ts__WEBPACK_IMPORTED_MODULE_3__.Functions.getSqlEditor(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#createViewModal').find('textarea'));
...
/* harmony import */ var _functions_handleCreateViewModal_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(62);
/* harmony import */ var _ajax_message_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(10);
/* harmony import */ var _functions_isStorageSupported_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(13);
/* harmony import */ var _tooltip_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(11);
...
/******/ __webpack_require__.O(0, [41], function() { return __webpack_exec__(56); });
