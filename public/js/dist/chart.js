...
var AbstractChart = function () {
  let elementId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
...
JQPlotChart.prototype.draw = function (data, options) {
  if (this.validator.validateColumns(data)) {
    this.plot = jquery__WEBPACK_IMPORTED_MODULE_0___default().jqplot(this.elementId, this.prepareData(data), this.populateOptions(data, options));
  }
};
...
JQPlotChart.prototype.toImageString = function () {
  if (this.plot !== null) {
    // @ts-ignore
    return jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + this.elementId).jqplotToImageStr({});
  }
};
...
JQPlotLineChart.prototype.populateOptions = function (dataTable, options) {
  ...
  var optional = {
    axes: {
      xaxis: {
        ...
        renderer: (jquery__WEBPACK_IMPORTED_MODULE_0___default().jqplot).CategoryAxisRenderer,
        ticks: []
      },
      yaxis: {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default().extend(true, optional, options);
...
JQPlotSplineChart.prototype.populateOptions = function (dataTable, options) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default().extend(true, optional, opt, compulsory);
  return optional;
};
/**
...
JQPlotScatterChart.prototype.populateOptions = function (dataTable, options) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default().extend(true, optional, options, compulsory);
  return optional;
};
...
JQPlotColumnChart.prototype.populateOptions = function (dataTable, options) {
  ...
  var compulsory = {
    seriesDefaults: {
      renderer: (jquery__WEBPACK_IMPORTED_MODULE_0___default().jqplot).BarRenderer
    }
  };
  jquery__WEBPACK_IMPORTED_MODULE_0___default().extend(true, optional, opt, compulsory);
  return optional;
...
JQPlotPieChart.prototype.populateOptions = function (dataTable, options) {
  var optional = {
    ...
    legend: {
      renderer: (jquery__WEBPACK_IMPORTED_MODULE_0___default().jqplot).EnhancedPieLegendRenderer
    }
  };
  var compulsory = {
    seriesDefaults: {
      shadow: false,
      renderer: (jquery__WEBPACK_IMPORTED_MODULE_0___default().jqplot).PieRenderer,
      rendererOptions: {
        sliceMargin: 1,
        showDataLabels: true
      }
...
/******/ __webpack_require__.O(0, [41], function() { return __webpack_exec__(0); });
