...
/* harmony import */ var _modules_navigation_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
/* harmony import */ var _modules_ajax_message_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(10);
/* harmony import */ var _modules_functions_getImageTag_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(18);
...
function exportPrivilegesModalHandler(data, msgbox) {
  if (typeof data !== 'undefined' && data.success === true) {
    ...
    modal.on('shown.bs.modal', function () {
      ...
      _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.getSqlEditor(modal.find('textarea'));
    });
    return;
  }
...
const PasswordStrength = {
  handleEvent: function () {
    ...
    _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.checkPasswordStrength(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val(), meterObj, meterObjLabel, username.val());
  }
};
/**
...
const ChangePasswordStrength = {
  handleEvent: function () {
    ...
    _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.checkPasswordStrength(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val(), meterObj, meterObjLabel, _modules_common_ts__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('user'));
  }
};
/**
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default().post(url, $form.serialize() + argsep + 'delete=' + $thisButton.val() + argsep + 'ajax_request=true', function (data) {
        if (typeof data !== 'undefined' && data.success === true) {
          ...
          $form.find('input:checkbox:checked').parents('tr').slideUp('medium', function () {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.checkboxesSel).trigger('change');
          });
        } else {
          (0,_modules_ajax_message_ts__WEBPACK_IMPORTED_MODULE_5__.ajaxShowMessage)(data.error, false);
        }
...
const CheckAddUser = {
  handleEvent: function () {
    ...
    return _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.checkPassword(jquery__WEBPACK_IMPORTED_MODULE_0___default()(theForm));
  }
};
...
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('server/privileges.js', function () {
  ...
  _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.getSqlEditor(jquery__WEBPACK_IMPORTED_MODULE_0___default()('textarea.export'));
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.checkboxesSel).trigger('change');
  _modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.Functions.displayPasswordGenerateButton();
  addOrUpdateSubmenu();
...
/******/ __webpack_require__.O(0, [41], function() { return __webpack_exec__(72); });
