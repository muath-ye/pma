...
function checkPrivilegesForDatabase() {
  var tableRows = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.server_databases');
  jquery__WEBPACK_IMPORTED_MODULE_0___default().each(tableRows, function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).on('click', function () {
      const db = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('data');
      if (db !== _modules_common_ts__WEBPACK_IMPORTED_MODULE_4__.CommonParams.get('db')) {
...
/******/ __webpack_require__.O(0, [41], function() { return __webpack_exec__(70); });
