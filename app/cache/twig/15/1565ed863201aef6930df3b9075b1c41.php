...
/* list_navigator.twig */
class __TwigTemplate_945979ee75429925083e4235bd9e88bd extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Page number:");
  ...
  ";
            ...
            if ((($context["position"] ?? null) > 0)) {
                ...
                echo "\" data-post=\"";
                echo $this->env->getFunction('get_common')->getCallable()(twig_array_merge(($context["url_params"] ?? null), [($context["param_name"] ?? null) => 0]), "", false);
                echo "\"";
...
echo _pgettext("First page", "Begin");
    ...
    <a href=\"";
                ...
                echo ($context["script"] ?? null);
                echo "\" data-post=\"";
                echo $this->env->getFunction('get_common')->getCallable()(twig_array_merge(($context["url_params"] ?? null), [($context["param_name"] ?? null) => (($context["position"] ?? null) - ($context["max_count"] ?? null))]), "", false);
                echo "\"";
                echo (((($context["frame"] ?? null) == "frame_navigation")) ? (" class=\"ajax\"") : (""));
                echo " title=\"";
...
echo _pgettext("Previous page", "Previous");
  ...
  <form action=\"";
    ...
    ";
            // line 27
            echo $this->env->getFunction('get_hidden_inputs')->getCallable()(($context["url_params"] ?? null));
            echo "
...
echo _pgettext("Next page", "Next");
    ...
    ";
                ...
                echo ($context["script"] ?? null);
                echo "\" data-post=\"";
                echo $this->env->getFunction('get_common')->getCallable()(twig_array_merge(($context["url_params"] ?? null), [($context["param_name"] ?? null) => (((($context["last_pos"] ?? null) == ($context["count"] ?? null))) ? ((($context["count"] ?? null) - ($context["max_count"] ?? null))) : (($context["last_pos"] ?? null)))]), "", false);
                echo "\"";
                echo (((($context["frame"] ?? null) == "frame_navigation")) ? (" class=\"ajax\"") : (""));
                echo " title=\"";
...
";
    ...
    {
        return new Source("", "list_navigator.twig", "A:\\SwadiServer\\www\\pma\\resources\\templates\\list_navigator.twig");
    }
}
