...
class __TwigTemplate_55f83ace29eda4307cd0f51a1a939098 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Home");
          ...
          ";
            ...
            if ((($context["server"] ?? null) > 0)) {
                ...
                echo "\">";
                // line 31
                echo $this->env->getFunction('get_image')->getCallable()("s_loggoff", (((($context["auth_type"] ?? null) == "config")) ? (_gettext("Empty session data")) : (_gettext("Log out"))));
                // line 32
                echo "</a>
          ";
            }
...
echo _gettext("phpMyAdmin documentation");
          ...
          <a href=\"";
            ...
            echo "\" target=\"_blank\" rel=\"noopener noreferrer\">";
            // line 40
            echo $this->env->getFunction('get_image')->getCallable()("b_sqlhelp", ((($context["is_mariadb"] ?? null)) ? (_gettext("MariaDB Documentation")) : (_gettext("MySQL Documentation"))));
            // line 41
            echo "</a>
...
";
    ...
    {
        return new Source("", "navigation/main.twig", "A:\\SwadiServer\\www\\pma\\resources\\templates\\navigation\\main.twig");
    }
}
