...
class __TwigTemplate_7c838daeaaea95173691db24fed7e2cb extends Template
{
    private $source;
    private $macros = [];
...
") : (""));
    ...
    ";
        ...
        if (($context["set_value"] ?? null)) {
            ...
            echo "\">";
            // line 58
            echo $this->env->getFunction('get_image')->getCallable()("b_edit", twig_sprintf(_gettext("Set value: %s"), ($context["set_value"] ?? null)));
            // line 59
            echo "</a>
    ";
        }
