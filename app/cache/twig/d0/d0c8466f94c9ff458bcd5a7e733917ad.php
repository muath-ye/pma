...
/* footer.twig */
class __TwigTemplate_79a0ebf1e93fd79afaadac860bbbf06c extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("phpMyAdmin Demo Server");
        ...
        ";
                ...
                if ( !twig_test_empty(($context["git_revision_info"] ?? null))) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getFilter('link')->getCallable()(twig_get_attribute($this->env, $this->source, ($context["git_revision_info"] ?? null), "revisionUrl", [], "any", false, false, false, 32)), "html", null, true);
                    echo "\">";
                    ...
                    // line 35
                    echo "<a target=\"_blank\" rel=\"noopener noreferrer\" href=\"";
                    echo twig_escape_filter($this->env, $this->env->getFilter('link')->getCallable()(twig_get_attribute($this->env, $this->source, ($context["git_revision_info"] ?? null), "branchUrl", [], "any", false, false, false, 35)), "html", null, true);
                    echo "\">";
...
";
    ...
    {
        return new Source("", "footer.twig", "A:\\SwadiServer\\www\\pma\\resources\\templates\\footer.twig");
    }
}
