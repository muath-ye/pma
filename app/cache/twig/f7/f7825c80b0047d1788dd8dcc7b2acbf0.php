...
/* login/form.twig */
class __TwigTemplate_c0185c91aa2ba177bf5a540297507d00 extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\" id=\"login_form\" action=\"index.php?route=/\" name=\"login_form\" class=\"";
  ...
  ";
        // line 50
        echo "  ";
        echo $this->env->getFunction('get_hidden_inputs')->getCallable()(($context["form_params"] ?? null), "", "server");
        echo "
...
";
    ...
    {
        return new Source("", "login/form.twig", "A:\\SwadiServer\\www\\pma\\resources\\templates\\login\\form.twig");
    }
}
